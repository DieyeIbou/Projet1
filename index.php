        ...
        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="img/5.jpg" class="d-block w-100" alt="Photo 1" style="width: 1000px; height: 300px;">
              </div>
              <div class="carousel-item">
                <img src="img/9.jpg" class="d-block w-100" alt="photo 2" style="width: 1000px; height: 300px;">
                </div>
                <div class="carousel-item">
                  <img src="img/10.jpg" class="d-block w-100" alt="photo 3" style="width: 1000px; height: 300px;">
                  </div>
                </div>
              </div>
            </div>
