...
<!-- Carrousel d'images -->
      ...
      <div id="imageCarousel" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            <img src="../img/5.jpg" class="d-block w-100" alt="Image 2">
          </div>
          <div class="carousel-item">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6">
        <!-- Contenu texte -->
        <h2 class="display-5 text-center">QUI SOMMES-NOUS</h2>
        <h2 class="text-center text-primary category-card">Réseaux et Techniques Numériques</h2>
        <p class="text-center category-card">
          ...
          <p>Elle dispense des formations rigoureuses basées sur des supports de cours, fruits de recherches approfondies. Ces supports testés et avérés permettent aux apprenants d’être aussitôt opérationnels.
        </p>
      </div>
      <div class="col-lg-6">
         <p>
                  ...
                  <h3>Le groupe RTN/EC2LT est formé de deux labels :<h3>
                    <p>Réseaux et Techniques Numériques<p>
                      <p>Ecole Centrale des Logiciels Libres et de Télécommunications</p>
                      </p>
        <!-- Image -->
    ...
    <p class="section-coloree2">
      ...
      RTN a su diversifier ses domaines de compétences afin de proposer aux entreprises et administrations des offres de servives dans plusieurs secteurs informatiques.
                             ...
                             <section id="about" class="py-5" style="background-color: #555b61;padding: 20px;">
                                      ...
                                      <div class="row">
                                        <div class="col-md-6">
                                          <img src="../img/12.jpg" class="img-fluid" alt="Image 1">
                                        </div>
                                        <div class="col-md-6">
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-md-6">
                                          <img src="../img/14.jpg" class="img-fluid" alt="Image 2">
                                        </div>
                                      </div> 
                                      </div>
